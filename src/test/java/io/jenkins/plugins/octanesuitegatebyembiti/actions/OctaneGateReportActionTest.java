...
public class OctaneGateReportActionTest {
  ...
  public void attachesToBuildAndRendersReportPage() throws Exception {
    ...
    assertTrue(xml.contains("#00e676"));
    assertTrue(xml.contains("#00b85e"));
    assertTrue(xml.contains("COMPLETE_PROGRESS_COLORS"));
    assertTrue(xml.contains("execution: \"#3c8c40\""));
    assertTrue(xml.contains("timeout: \"#cc644c\""));
    assertTrue(xml.contains("poll: \"#00b85e\""));
